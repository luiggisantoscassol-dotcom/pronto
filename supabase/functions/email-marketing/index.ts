...
const template = (input: Record<string, unknown>, includeUnsubscribe: boolean) => {
  ...
  const blocks: Record<string, string> = {
    logo: `<tr><td style="background:#fff;text-align:${styles.logo.alinhamento};padding:30px 32px 26px;border-bottom:1px solid #eee7dc"><img src="https://www.tionan.com.br/logo-tio-nan-email.png" width="190" alt="Tio Nan" style="display:inline-block;width:190px;max-width:100%;height:auto"></td></tr>`,
